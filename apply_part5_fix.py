...
formula_specs = [
    {
        ...
        "time": "2024",
        "assumptions": "Standard CPHEEO domestic urban supply norm for piped sewerage towns (135 LPCD) applied to 2011 Census population base (200,564 persons).",
        "confidence": "HIGH",
        "execution_status": "EXECUTED",
        "output_records": ["WAT-DER-001"],
        "notes": "Derived baseline municipal demand (27.076 MLD). Does not replace metered consumption."
    },
    {
        "formula_id": "FORMULA_PURI_WAT_002",
        "target_metric": "tourist_floating_water_demand",
        "formula": "Annual Tourist Person-Nights (3,500,000) * Tourism Water Norm (368.28 LPCD) / 365 / 1,000,000",
        "input_records": "TOUR_001, TOUR_002, VIS_001",
        "input_sources": "SRC_DOT_STAT_BULLETIN_2023, SRC_DOT_STAT_BULLETIN_2024, CPHEEO/MoUD Manual Table 2.1",
        "unit": "MLD",
        "geography": "PURI_TOURIST_CENTRE",
        "time": "2024",
        "assumptions": "CPHEEO / Ministry of Urban Development (MoUD) Manual on Water Supply and Treatment (Table 2.1 commercial hotel weighted norm: 368.28 LPCD) applied to estimated 3.50M annual hotel person-nights.",
        "confidence": "MEDIUM",
        "execution_status": "EXECUTED",
        "output_records": ["WAT-DER-002"],
        "notes": "Floating tourist accommodation water demand: 3.50M * 368.28 / 365 / 1,000,000 = 3.531 MLD (Corrected from 1.289 MLD)."
    },
    {
        "formula_id": "FORMULA_PURI_WAT_003",
        "target_metric": "total_estimated_water_demand",
        "formula": "Resident Demand (WAT-DER-001: 27.076 MLD) + Tourist Demand (WAT-DER-002: 3.531 MLD)",
        "input_records": "WAT-DER-001, WAT-DER-002",
        "input_sources": "SRC_CENSUS_2011_PURI, SRC_DOT_STAT_BULLETIN_2024, CPHEEO/MoUD Manual Table 2.1",
        "unit": "MLD",
        "geography": "PURI_TOURIST_CENTRE",
        "time": "2024",
        "assumptions": "Additive sum of verified resident domestic demand (27.076 MLD) and hospitality floating demand (3.531 MLD).",
        "confidence": "MEDIUM",
        "execution_status": "EXECUTED",
        "output_records": ["WAT-DER-003"],
        "notes": "Total theoretical water demand under standard engineering norms: 27.076 + 3.531 = 30.607 MLD (Corrected from 28.365 MLD)."
    },
    {
        ...
        "notes": "Normalized single-dimension room capacity for Panthanivas Puri (50 rooms)."
    },
    {
        ...
        "notes": "Normalized single-dimension bed capacity for Panthanivas Puri (108 beds)."
    },
    {
        "formula_id": "FORMULA_PURI_VIS_001",
        "target_metric": "visitor_share_domestic_pct",
        ...
        "geography": "PURI_TOURIST_CENTRE",
        "time": "2024",
        "assumptions": "Direct arithmetic ratio of verified domestic footfall to total centre visits from Odisha Tourism Bulletin 2024.",
        "confidence": "HIGH",
        "execution_status": "EXECUTED",
        "output_records": ["VIS-DER-DOM-SHARE-2024"],
        "notes": "Domestic visitors represent 99.67% of total visitor volume in CY 2024."
    },
    {
        "formula_id": "FORMULA_PURI_VIS_002",
        "target_metric": "visitor_share_foreign_pct",
        ...
        "geography": "PURI_TOURIST_CENTRE",
        "time": "2024",
        "assumptions": "Direct arithmetic ratio of verified international footfall to total centre visits from Odisha Tourism Bulletin 2024.",
        "confidence": "HIGH",
        "execution_status": "EXECUTED",
        "output_records": ["VIS-DER-FOR-SHARE-2024"],
        "notes": "Foreign visitors represent 0.33% of total visitor volume in CY 2024."
    },
    {
        "formula_id": "FORMULA_PURI_VIS_003",
        "target_metric": "yoy_visitor_growth_pct",
        ...
        "geography": "PURI_TOURIST_CENTRE",
        "time": "2024",
        "assumptions": "Year-over-year annual percentage change in official tourist centre visits between CY 2023 and CY 2024.",
        "confidence": "HIGH",
        "execution_status": "EXECUTED",
    ...
    },
    {
        ...
        "formula": "Rath Yatra Peak Single Day Influx (1,500,000) / Average Daily Visits (8,346,128 / 365 = 22,866.1)",
        ...
        "notes": "Rath Yatra peak surge is 65.60x baseline daily visitor density."
    },
    {
        ...
        "geography": "PURI_MUNICIPALITY",
        "time": "FY 2023-24",
        "assumptions": "Calculates municipal waste generation intensity per permanent resident from verified statutory weighbridge tonnage.",
        "confidence": "HIGH",
        "execution_status": "EXECUTED",
...
# 2. Compile Corrected Derived Observations
derived_observations = [
    ...
    },
    {
        ...
        "formula_id": "FORMULA_PURI_WAT_001",
        "calculation_formula": "Population (200,564) * 135 LPCD / 1,000,000 = 27.07614 MLD -> 27.076 MLD",
        "input_record_ids": "COMM_POP_2011_CENSUS",
        "input_source_ids": "SRC_CENSUS_2011_PURI",
        "assumptions": "CPHEEO urban water supply engineering benchmark (135 LPCD) applied to 2011 Census municipal population (200,564 persons).",
        "limitations": "Theoretical domestic demand baseline; does not replace measured telemetry consumption.",
        "notes": "Derived municipal domestic water demand baseline under standard CPHEEO urban norms (27.076 MLD)."
    },
    {
        ...
        "formula_id": "FORMULA_PURI_WAT_002",
        "calculation_formula": "Annual Tourist Person-Nights (3,500,000) * 368.28 LPCD / 365 / 1,000,000 = 3.531452 MLD -> 3.531 MLD",
        "input_record_ids": "TOUR_001, TOUR_002, VIS_001",
        "input_source_ids": "SRC_DOT_STAT_BULLETIN_2024, CPHEEO/MoUD Manual Table 2.1",
        "assumptions": "CPHEEO / Ministry of Urban Development (MoUD) Manual on Water Supply and Treatment (Table 2.1 commercial hotel weighted norm: 368.28 LPCD) applied to estimated 3.50M annual hotel person-nights.",
        "limitations": "Estimates floating hospitality load; does not account for transient day-trip pilgrim tap usage.",
        "notes": "Derived floating tourist accommodation water demand: 3.50M * 368.28 / 365 / 1,000,000 = 3.531 MLD (Corrected from 1.289 MLD per Part 5 Final Fix)."
    },
    {
        ...
        "verification_status": "VERIFIED",
        "value_type": "DERIVED",
        "source_code": "SRC_CENSUS_2011_PURI, SRC_DOT_STAT_BULLETIN_2024",
        "dataset_code": "DS_PURI_WATER",
        "geographic_scope": "PURI_TOURIST_CENTRE",
        "confidence": "MEDIUM",
        "historical_flag": "FALSE",
        ...
        "formula_id": "FORMULA_PURI_WAT_003",
        "calculation_formula": "WAT-DER-001 (27.076 MLD) + WAT-DER-002 (3.531 MLD) = 30.607 MLD",
        "input_record_ids": "WAT-DER-001, WAT-DER-002",
        "input_source_ids": "SRC_CENSUS_2011_PURI, SRC_DOT_STAT_BULLETIN_2024, CPHEEO/MoUD Manual Table 2.1",
        "assumptions": "Additive sum of verified resident domestic demand (27.076 MLD) and hospitality floating demand (3.531 MLD).",
        "limitations": "Theoretical demand total; distinct from WATCO piped supply capacity (36-42 MLD).",
        "notes": "Total theoretical water demand under standard engineering norms: 27.076 + 3.531 = 30.607 MLD (Corrected from 28.365 MLD per Part 5 Final Fix)."
    },
    {
        ...
        "formula_id": "FORMULA_PURI_VIS_001",
        "calculation_formula": "(Domestic Visits 8,318,172 / Total Visits 8,346,128) * 100 = 99.66504% -> 99.67%",
        ...
        "notes": "Domestic visitors constitute 99.67% of total footfall in CY 2024."
    },
    {
        ...
        "formula_id": "FORMULA_PURI_VIS_002",
        "calculation_formula": "(Foreign Visits 27,956 / Total Visits 8,346,128) * 100 = 0.33496% -> 0.33%",
        ...
        "limitations": "Destination-level tourist centre aggregation.",
        "notes": "Foreign visitors constitute 0.33% of total footfall in CY 2024."
    },
    {
        ...
        "formula_id": "FORMULA_PURI_VIS_003",
        "calculation_formula": "((8,346,128 - 7,012,308) / 7,012,308) * 100 = 19.02112% -> +19.02%",
    ...
    },
    {
        ...
        "formula_id": "FORMULA_PURI_VIS_004",
        "calculation_formula": "Rath Yatra Peak Influx (1,500,000) / (Annual Visits 8,346,128 / 365 = 22,866.104) = 65.59928 -> 65.60x",
        ...
        "notes": "Rath Yatra peak festive day represents a 65.60x surge above average daily visitor volume."
    },
    {
        ...
        "formula_id": "FORMULA_PURI_WASTE_001",
        "calculation_formula": "(70.4 TPD * 1,000 kg) / 200,564 residents = 0.35101 kg -> 0.351 kg/capita/day",
...
ws_d2.append(["arithmetic_qa_status", "PASS (10/10)", "All mathematical calculations independently re-verified"])
...
# Mirror to backend root directories
d_dst_dir = r"C:\S21_new\backend\derived\PURI"
os.makedirs(d_dst_dir, exist_ok=True)
shutil.copy2(out_derived, os.path.join(d_dst_dir, "PURI_DERIVED_OBSERVATIONS.xlsx"))

f_dst_dir = r"C:\S21_new\backend\framework"
os.makedirs(f_dst_dir, exist_ok=True)
shutil.copy2(out_formula, os.path.join(f_dst_dir, "PURI_DERIVATION_FORMULA_REGISTER.xlsx"))

print("PURI_DERIVED_OBSERVATIONS.xlsx and PURI_DERIVATION_FORMULA_REGISTER.xlsx updated and mirrored successfully.")
